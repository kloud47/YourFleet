...
export default function () {
    ...
    return (
        <div className="w-screen h-screen flex justify-center items-center">
            <Back />
            <div className="h-[65vh] flex w-[60vw] bg-background shadow-2xl">
                <div className="w-[50%] bg-secondary p-6">
                    <h1 className="font-black text-primary text-3xl text-center border-b border-foreground pb-5">Sign in</h1>
                    ...
                    <div className="text-muted-foreground mt-8 text-center">
                        Already signed in?<Link href={"/sign-up"} className="text-[#4285F4] font-bold">Signup</Link>
                    </div>
                    </form>
                </div>
