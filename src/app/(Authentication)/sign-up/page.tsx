        ...
        <div className="w-screen h-screen flex justify-center items-center">
            ...
            <div className="h-[65vh] flex w-[60vw] bg-[#000] shadow-2xl">
                <div className="w-[50%] bg-secondary p-6">
                    <h1 className="font-black text-[#fff] text-3xl text-center border-b border-[#9d7b9c] pb-5">Sign up</h1>
                    <form onSubmit={handleSubmit} className="flex flex-col pt-3">
                        <label htmlFor="name" className="pl-2">Name</label>
                        <input type="text" name="name" className=" outline-none opacity-50 z-10 p-1 text-[#fff] placeholder:text-slate-500 rounded-md mb-3 bg-muted"
